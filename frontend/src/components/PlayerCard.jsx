export default function PlayerCard({ player }) {
    ...
    return (
        <div className="relative group animate-slide-up">
            ...
            <div className={`absolute -inset-1 rounded-[1.5rem] md:rounded-[2rem] opacity-20 blur-xl group-hover:opacity-40 transition duration-1000 group-hover:duration-200 
            ...
            <div className="relative glass-card overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start gap-4 md:gap-6">
                        <div className="space-y-2">
                            <div className="flex items-center gap-3">
                                ...
                                {isOverseas && (
                                    <span className="bg-white/10 text-white text-[9px] md:text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-tighter">
                                        Overseas
                                    </span>
                                )}
                            </div>
                            <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight uppercase italic break-words">
                                {player.name}
                            </h2>
                ...
                <div className="absolute right-0 bottom-0 opacity-5 pointer-events-none overflow-hidden">
                     <span className="text-6xl sm:text-8xl md:text-[120px] font-black italic tracking-tighter select-none uppercase inline-block translate-y-4 translate-x-4">
                        {(player.role || "").split(' ')[0]}
                     </span>
                </div>
            </div>
